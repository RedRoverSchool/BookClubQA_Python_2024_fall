...
class Announcement:
    ...
    def fill_out_descripption(self):
        self.page.fill('trix-editor[input="id_description"]', 'Teacher, that knows everything')
    ...
    def checkbox_degree(self):
        ...
        assert degree_checkbox.is_checked(), "The 'has degree' checkbox should be checked"
    ...
    def checkbox_free_first_lesson(self):
        ...
        assert free_first_lesson_checkbox.is_checked(), "The 'free first lesson' checkbox should be checked"
