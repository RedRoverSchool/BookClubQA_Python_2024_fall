...
@pytest.mark.parametrize('data', site_pages_urls, ids=[u["name"] for u in site_pages_urls])
def test_profile_btn_visibility(user_profile, header, login, data, page: Page):
...
@pytest.mark.parametrize('data', site_pages_urls, ids=[u["name"] for u in site_pages_urls])
def test_profile_btn_hover(user_profile, header, login, data, page: Page):
